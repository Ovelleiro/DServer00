...
<body>
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="crear_bd.php">Crear BD</a>
                        </li>
                        <li class="nav-item">
    ...
    <main>
        <form action="crear_bd.php" method="post">
            <div class="mb-3">
                <label for="nombreBD" class="form-label">Nombre de la BD:</label>
                <input type="text" class="form-control" name="nombreBD" id="nombreBD" placeholder="Introduce aquí el nombre para la BD" />
    ...
    if (isset($_POST['enviar'])) {
        $sql = "CREATE DATABASE ".$_POST['nombreBD'];
        $resultado = $conexion->query($sql);
        if ($resultado) {
            echo "<p>Se creó la base de datos ".$_POST['nombreBD']."</p>";
        }
    }
    ?>
    <footer>
